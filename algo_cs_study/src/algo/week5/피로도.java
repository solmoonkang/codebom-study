...
public class 피로도 {
    ...
    public boolean[] visitedDungeon;

    public int solution(int k, int[][] dungeons) {
        visitedDungeon = new boolean[dungeons.length];
    ...
    public void dfs(int depth, int k, int[][] dungeons) {
        for (int i = 0; i < dungeons.length; i++) {
            if (!visitedDungeon[i] && dungeons[i][0] <= k) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Result: " + fatigue.solution(80, dungeons));
    }
}
