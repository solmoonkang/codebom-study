...
public class 점프와순간이동 {
    ...
    public static void main(String[] args) {
        점프와순간이동 jumpAndTeleportation = new 점프와순간이동();
        System.out.println("jumpAndTeleportation = " + jumpAndTeleportation.solution(5));
        System.out.println("jumpAndTeleportation = " + jumpAndTeleportation.solution(6));
        System.out.println("jumpAndTeleportation = " + jumpAndTeleportation.solution(5000));
    }
}
