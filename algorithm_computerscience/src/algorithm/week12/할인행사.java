...
public class 할인행사 {
    ...
    public int solution(String[] want, int[] number, String[] discount) {
        ...
        for (int i = 0; i <= discount.length - 10; i++) {
            Map<String, Integer> tempWantList = new HashMap<>(wantList);

            for (int j = i; j < i + 10; j++) {
                String product = discount[j];
                tempWantList.put(product, tempWantList.getOrDefault(product, 0) - 1);
            }

            if (isAllProductMatched(tempWantList)) count++;
        }

        return count;
    }

    private boolean isAllProductMatched(Map<String, Integer> tempWantList) {
        for (int count : tempWantList.values()) {
    ...
    public static void main(String[] args) {
        할인행사 discountEvent = new 할인행사();

        String[] firstWant = {"banana", "apple", "rice", "pork", "pot"};
        int[] firstNumber = {3, 2, 2, 2, 1};
        String[] firstDiscount = {"chicken", "apple", "apple", "banana", "rice", "apple", "pork", "banana", "pork", "rice", "pot", "banana", "apple", "banana"};
        System.out.println("discountEvent = " + discountEvent.solution(firstWant, firstNumber, firstDiscount));

        String[] secondWant = {"apple"};
        int[] secondNumber = {10};
        String[] secondDiscount = {"banana", "banana", "banana", "banana", "banana", "banana", "banana", "banana", "banana", "banana"};
        System.out.println("discountEvent = " + discountEvent.solution(secondWant, secondNumber, secondDiscount));
    }
}
